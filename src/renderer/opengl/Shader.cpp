...
namespace EnGl 
{
	...
	u32 Shader::GetLocation(const std::string& name) const
	{
		u32 loc;
	...
	void Shader::SetUniform(const std::string& name, u32 value) const
	{
	...
	void Shader::SetUniform(const std::string& name, f64 value) const
	{
	...
	void Shader::SetUniform(const std::string& name, const Texture& value, u32 unit) const
	{
